...
# // USERNAME IZIN IPP
rm -f /usr/bin/user
username=$(curl -sS https://raw.githubusercontent.com/Valkry8/Regist/MONSTER/afk | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user

# // VALIDITY
rm -f /usr/bin/e
valid=$(curl -sS https://raw.githubusercontent.com/Valkry8/Regist/MONSTER/afk | grep $MYIP | awk '{print $3}')
...
Exp1=$(curl -sS https://raw.githubusercontent.com/Valkry8/Regist/MONSTER/afk | grep $MYIP | awk '{print $3}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
#echo -e "        ${z}❒════════════════════════════════════════════❒${NC}" 
#echo -e "                ${KIRI}${z}GONDRONG VPN TNL${z}${KANAN}"
...
#echo -e " ${z}╰════════════════╯╰══════════════════╯╰════════════════════╯${NC}"
echo -e " ${z}╭══════════════════════════════════════════════════════════╮${NC}"
echo -e " ${z}│$NC${z} Dev.Sc$NC        ${z}=$NC GONDRONG VIP"
