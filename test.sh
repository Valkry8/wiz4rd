...
logofigh() {
 echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To VPN VIP ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}Tnl® ${NC}${YELLOW}(${NC} ${green} AMN ${NC}${YELLOW})${NC}"
echo -e " © Recode By My GONDRONG Tnl${YELLOW}(${NC} 2026 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
